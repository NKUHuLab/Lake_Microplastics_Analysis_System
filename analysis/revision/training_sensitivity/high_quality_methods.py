# -*- coding: utf-8 -*-
"""审稿人#1 意见#1 — 高质量方法子集 (polygon面染色版)"""
...
def main():
    ...
    U.plot_sensitivity_map(merged_gdf, 'GnBu',
        f'High-Quality Methods Only (Score≥4, n={len(df_sub)})',
        os.path.join(OUT, '敏感性_高质量方法_map'))

    with open(os.path.join(OUT,'敏感性_高质量方法_reservoir.txt'),'w',encoding='utf-8') as f:
